...
- Feature file is at: `karate-tests/tests/items_item_id_name_get.feature`
...
```bash
java -Dkarate.config.dir=karate-tests/config -jar Downloads/karate-1.5.1.jar karate-tests/tests/items_item_id_name_get.feature
```
